...
* Recall from {numref}`sec:hardware`, that the RFSoC 4x2 board has 4 RF
  ...
  `eee4511c_vitis_platform` configures ADC-D (ADC0 on tile 224) on
  the RFSoC 4x2 board at sampling rate 307.2 Msps.

* The main goal of this section is to discuss how to use the ADC
  configured in `eee4511c_vitis_platform` as a signal source to our
